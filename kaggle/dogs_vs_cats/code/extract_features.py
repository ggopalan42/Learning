...
for i in np.arange(0, len(imagePaths), bs):
    ...
    # Orig -> features = features.reshape((features.shape[0], 2048))
    # Fixed by GG per below. The shape of features is: N, 7, 7, 2048
    # where N = batchsize = 16 by default. Flattening this to: N, 7 * 7 * 2048
